...
//Constructor, creates clock to set date of creation & calculates the price based on in_x_days.
...
//Takes the amount of workdays required through in_x_days and returns a float price. 
//expr_surcharge and pay_per_day are defined in utilities/constantdefs.h
