...
//checks that provided order pointer is not null, throws an error if it is, else edits the assigned employee id of the order to the employee specified 
...
//uses the order repository to fetch completed orders and calculate their total revenue, constructs a report and adds it to a receptionist report repository
